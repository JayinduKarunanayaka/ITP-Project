...
const getRequestedPatientId = (req) => req.params?.patientId || req.body?.patientId || req.body?._id;
...
// Backwards-compatible alias for legacy callers that still reference the older route/controller shape.
export { addPatientToCaretaker as linkToCaretaker };
