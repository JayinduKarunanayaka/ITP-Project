...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      desc: "Share your experience and suggest features. Your direct feedback helps us quickly refine and personalize your health tracking journey.",
      image: assets.Feedback_img,
      reverse: true,
      tags: ["Direct System Feedback", "User Rating Dashboard", "Feature Requests"]
    }
  ]
